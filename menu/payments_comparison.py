...
def BuildPaymentsComparison(transaction_Payments):
    ...
    with row3[0]:
        ...
        function_copy_dataframe_as_tsv(filtered_copy)
        function_box_lenDf(len_df=count, df=filtered_copy, y='-100', x='500', box_id='box1', item='Propostas', total_line=True)
    ...
    with row4[0]:
        ...
        function_copy_dataframe_as_tsv(filtered_copy)
        function_box_lenDf(len_df=count, df=filtered_copy, y='-100', x='500', box_id='box1', item='Pagamentos', total_line=True)
